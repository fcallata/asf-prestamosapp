...
public class JwtAuthorizationFilter extends BasicAuthenticationFilter {
    ...
    public JwtAuthorizationFilter(AuthenticationManager authenticationManager, UsuarioDAO usuarioDAO) {
    ...
    private Authentication getUsernamePasswordAuthentication(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            //busca de la db el usuario
            if (userName != null) {
                Usuario usuario = this.usuarioDAO.findByNombre(userName);
                MyUserPrincipal principal = new MyUserPrincipal(usuario);
